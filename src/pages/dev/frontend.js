...
<section class="sec"><div class="wrap">
  ...
  <div class="dev-scroll"><table class="dev-table">
    ...
    <tbody>
      ...
      <tr><td>Company Admin</td><td><code>/admin/*</code></td><td>11</td><td>163</td><td>${L('Employees, teams, reports, rewards, activity log, settings (Company Admin scope).','Karyawan, tim, laporan, reward, activity log, pengaturan (lingkup Company Admin).','従業員、チーム、レポート、報酬、操作ログ、設定（Company Adminスコープ）。')}</td></tr>
