...
<section class="sec tinted"><div class="wrap">
  ...
  <div class="dev-scroll"><table class="dev-table">
    ...
    <tbody>
      ...
      <tr><td>Administration</td><td>1</td><td>2</td><td>R1±</td><td>MVP-adjacent</td><td>${L('EMENDA\\u2019s own operational tools — the Super Admin internal console.','Perkakas operasional EMENDA sendiri — konsol internal Super Admin.','EMENDA自身の運用ツール。Super Admin内部コンソール。')}</td></tr>
