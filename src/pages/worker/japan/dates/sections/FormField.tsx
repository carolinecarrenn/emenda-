...
/* WD-36B/C form-field pattern: 10px semibold uppercase grey micro-label,
...
/* Mobile geometry is the W-36B/D frame (628:1092): 50px field, 13px inset,
...
/** 10px micro-label; W-36D 628:1133 turns it red alongside the field. */
...
/** W-36D 628:1136 — 11px red message under the field, never inside it. */
...
export function TextField({
  ...
  /** Inline validation message shown in the empty input (WD-36D style). */
  error?: string;
}) {
...
/** Sheet-internal editable date input (WD-36K picker pattern). */
